...
const painPoints = [
  {
    icon: BrickWall,
    title: 'Una pequeña grieta terminó siendo un problema mayor.',
    description:
      'Muchas reparaciones se retrasan porque no siempre es fácil saber qué hacer o cómo comenzar.',
  },
  {
    icon: Droplets,
    title: 'Las filtraciones vuelven cada invierno.',
    description: 'Muchas veces solo se cubre el daño visible sin resolver la causa.',
  },
  {
    icon: SunIcon,
  ...
  {
    icon: PackageCheck,
    title: 'No sabes qué materiales comprar.',
...
const reasons = [
  {
    value: '69%',
    title: 'con poca o ninguna inversión',
    description:
      'Entre propietarios del quintil de ingresos más bajo, la mayoría invirtió poco o nada en mejoras o mantenimiento durante 2023.',
  ...
  },
  {
    ...
    description:
      'En viviendas sin aire acondicionado, los techos fríos pueden reducir las temperaturas interiores máximas.',
    source: 'US EPA',
  },
  {
    value: '17°C',
    ...
    description:
      'Berkeley Lab muestra que una superficie clara puede mantenerse mucho más fresca que una oscura bajo el sol.',
  ...
  },
  {
    ...
    description:
      'Con solo una imagen, la aplicación puede iniciar el análisis del problema y brindar orientación personalizada.',
    source: 'Funcionalidad de la aplicación',
  },
];
...
const helpSteps = [
  ...
  },
  {
    ...
    description:
      'La IA identifica posibles causas y explica el problema con un lenguaje fácil de entender.',
  },
  {
    icon: Lightbulb,
    title: 'Recibe recomendaciones',
    description:
      'Sugiere materiales, alternativas y posibles soluciones adaptadas a tu situación.',
  },
];
...
const familyValues = [
  {
    ...
    description: 'Sugerimos alternativas cuando existen opciones más accesibles.',
  },
  {
    icon: ThermometerSun,
  ...
  },
  {
    ...
    description: 'Sin lenguaje técnico complicado.',
  },
  {
    icon: Home,
    ...
    <main className="landing-page">
      ...
      <section className="landing-hero landing-fade-up">
        <div className="landing-copy">
          <span className="eyebrow">Asistente Construcción</span>
          <h1>Tu hogar merece soluciones, no improvisaciones.</h1>
          <p>
            Una pequeña grieta, una gotera o una habitación demasiado caliente pueden convertirse
            en un gran problema. Nuestro asistente inteligente te ayuda a encontrar soluciones
            prácticas, económicas y adaptadas a tu hogar.
          </p>
      ...
      <section className="landing-section landing-fade-up" aria-labelledby="landing-reasons">
        <div className="landing-section-heading">
          ...
          <p>
            Detrás de muchas reparaciones hay una realidad que comparten millones de familias.
            Estos datos muestran por qué tomar decisiones informadas al construir o reparar un
      ...
      <section className="landing-center-story landing-fade-up">
        <div>
          <span className="eyebrow">Orientación antes de remodelar</span>
          <h2>No todos los hogares necesitan una remodelación.</h2>
          <p>A veces solo necesitan la orientación correcta para tomar mejores decisiones.</p>
        </div>
      ...
      <section className="landing-section landing-fade-up" aria-labelledby="landing-help">
        <div className="landing-section-heading">
          ...
          <h2 id="landing-help">¿Cómo puede ayudarte?</h2>
        </div>
      ...
      <section className="landing-section landing-fade-up" aria-labelledby="landing-families">
        <div className="landing-section-heading">
          <span className="eyebrow">Hecho para el país</span>
          <h2 id="landing-families">Construimos pensando en las familias salvadoreñas</h2>
        </div>
      ...
      <section className="landing-flow landing-final-cta landing-fade-up" aria-labelledby="landing-cta">
        <div>
          ...
          <p>
            Sube una fotografía y descubre cómo la inteligencia artificial puede ayudarte a tomar
